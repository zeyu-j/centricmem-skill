...
program
    ...
    .option("--link <path>", "link an explicit project path (repeatable)", (v, prev) => [...prev, v], [])
    ...
    if (result.skillInstalled)
        console.log(`Skill installed to ${path.join(result.workspaceRoot, "skills", "centricmem-agent")}/`);
