...
server.registerTool("centricmem_search", {
    ...
    description: "Full-text search over the project's memory (.centricmem/): decisions, rules, context, lessons. Supports type, status, and agent filters. Use before making assumptions about project conventions or past decisions.",
    inputSchema: {
...
server.registerTool("centricmem_log_lesson", {
    ...
    description: "Append a lesson (pitfall, gotcha, hard-won knowledge) to the current project's lessons.md. Call when you discover something that future sessions should know to avoid repeating mistakes.",
    inputSchema: {
