...
assert "MIT License" in lic, "LICENSE must be the MIT text"
assert "PolyForm Noncommercial License" not in lic, "the LICENSE file is still the PolyForm licence text"
